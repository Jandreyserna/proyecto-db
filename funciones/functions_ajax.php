...
}else if (!empty($_POST['actualizar_evento'])) {
...
?>
   ...
   <ul>
     <li>
       ...
       <h6><?= $informacion[0]['NameL'] ?></h6>
     </li>
     <li>
       <h5>Orador:</h5>
       <h6><?= $informacion[0]['Orador']  ?></h6>
     </li>
     <li>
       <h5>Salario Orador:</h5>
        <h6><?= $informacion[0]['Salario']  ?></h6>
      </li>
     <li>
       <h5>Costo:</h5>
       <h6><?= $informacion[0]['Costo']  ?></h6>
      </li>
     <li>
       <h5>Fecha de evento:</h5>
       <h6><?= $informacion[0]['Fecha_evento']  ?></h6>
     </li>
   ...
   <div class="crudd">
     <button class="btn btn-outline-success" type="button" name="button">
     <div class="container">
       <a href="#update" class="btn-crudd btn-sucess" data-toggle="collapse">Actualizar Evento</a>
     </div>
   </button>
   </div>
   ...
   <div id="update" class="collapse">
     <form action="" class="form-inline" method="post">
       <input  type="hidden" name="actualizar_evento" value="<?= $_POST['id'] ?>"/>
       <label >Material </label>
       <select class="evento" name="IdLibro" required>
         <option value="<?= $material[0]['IdLibro'] ?>" disabled selected><?= $material[0]['Nombre']?></option>
            <?php foreach ($promotores as $promo=> $datap): ?>
               <option value="<?= $datap['IdLibro'] ?>"> <?= $datap['Nombre']?></option>
            <?php endforeach; ?>
       </select>
       <p>
         <label for="campo1">Nombre de Evento </label>
         <input type="text"  name="Nombre" value="<?= $informacion[0]['Nombre']  ?>"/>
       </p>

       <p>
         <label for="campo1">Orador </label>
         <input type="text"  name="Orador" value="<?= $informacion[0]['Orador']  ?>"/>
       </p>

       <p>
         <label for="campo1">Salario </label>
         <input type="text"  name="Salario" value="<?= $informacion[0]['Salario']  ?>"/>
       </p>

       <p>
         <label for="campo1">Costo </label>
         <input type="text"  name="Costo" value="<?= $informacion[0]['Costo']  ?>"/>
       </p>

       <p>
         <label for="campo1">Fecha de Evento </label>
         <input type="date"  name="Fecha_evento" value="<?= $informacion[0]['Fecha_evento']  ?>"/>
       </p>
