...
function enqueue(){
  ...
  wp_register_style('libreria_datatable', 'https://cdn.datatables.net/v/dt/dt-1.10.24/datatables.min.css', time());
  ...
  wp_register_script('jquery', plugins_url('pluglin-libreria/js/jquery-3.6.0.min.js'),false , time());
  ...
  wp_register_script('datatables_js', 'https://cdn.datatables.net/1.10.24/js/jquery.dataTables.min.js', time() );
